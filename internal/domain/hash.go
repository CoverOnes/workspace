...
//
// Fields included: contractId (string), version (int), title (NFC-normalized,
// trailing-whitespace-trimmed), terms (NFC-normalized, trailing-whitespace-trimmed),
// amount (decimal string, fixed scale via decimal.StringFixed(2)), currency.
//
...
func CanonicalContractDigest(contractID, title, terms, amount, currency string, version int) string {
